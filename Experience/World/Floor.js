...
export default class Floor {
    ...
    setFloor() {
        ...
        this.material.color.set(0xf6f0e1).convertSRGBToLinear();
    ...
    setCircles() {
        ...
        material1.color.set(0xff8787).convertSRGBToLinear();

        const material2 = new THREE.MeshStandardMaterial();
        material2.color.set(0x8395cd).convertSRGBToLinear();

        const material3 = new THREE.MeshStandardMaterial();
        material3.color.set(0x7ad0ac).convertSRGBToLinear();
